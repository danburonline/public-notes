...
[Biomimetic neuromorphics](Biomimetic%20neuromorphics.md) is the engineering discipline tasked with satisfying the invariance criterion in practice. For [ECP](../../001_private/_%20general/PSNST.md)'s progressive transfer, the synthetic substrate must implement — not merely simulate — equivalent dynamics, such that the temporal derivatives $\frac{\partial O}{\partial t}$ are preserved across the biological-to-synthetic boundary. This distinguishes ECP from digitisation approaches like the [Moravec transfer](../../001_private/social-media/x/Moravec%20transfer.md), where invariance is achieved (if at all) through external simulation rather than substrate-level equivalence.
