...
| :--------------------- | :-------------------------------------------------------------------------------------- | :------------------------------- |
| **Invasive**           | Requires [craniotomy](../../001_private/books/the_feeling_of_life_itself/craniotomy.md) | Cortical electrode grids         |
| **Minimally Invasive** | Endovascular approach                                                                   | Stentrode via jugular vein       |
| **Non-invasive**       | External devices                                                                        | EEG headsets                     |
...
- **Pre-IDEAL/Stage 0**: Bench work such as the GelMA transport study, modelling, simulation, cadaveric work, and justified porcine or non-human-primate studies of [cortical organoid](organoid_types.md) implantation reduce foreseeable FIH risks
...
The framework's emphasis on prospective registration and standardised outcome reporting is particularly relevant for Eightsix Science's graft-implant pre-pilot programme, where reproducibility and safety data can inform later clinical and regulatory planning.
