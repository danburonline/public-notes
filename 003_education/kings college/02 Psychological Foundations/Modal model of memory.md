...
- [[Working memory model]]: Baddeley's elaboration of short-term memory with multiple components (phonological loop, visuospatial sketchpad, central executive)
- [[Long-term memory]]: Permanent storage subdivided into explicit (declarative) and implicit (procedural) memory
- [[Flashbulb memories]]: Vivid, detailed memories of emotionally significant events
- [[Mood-congruent memory and mood-dependent memory]]: How emotional states influence encoding and retrieval
- [[Overgeneral autobiographical memory]]: Difficulty retrieving specific episodic memories (associated with depression)
- [[Engram]]: The physical trace of a memory in neural tissue
