...
- **Remote Advice (e.g., NHS 111):**
  ...
  - **Emergency Department Referral (not necessarily 999):**
    - _Any_ loss of consciousness (even if recovered).
    - Amnesia.
    - Persistent headache.
    - Vomiting.
...
- **Tranexamic Acid:**
  - **GCS ≤12 _and_ no active _extracranial_ bleeding.**
  - Give within 2 hrs.
...
- **NO Direct Access Imaging:** Patients should _not_ be referred for neuroimaging directly from the community.
...
### Adults (16 and over) - _Immediate_ CT (within 1 hour)
...
### Adults (16 and over) - CT within 8 Hours (or 1 Hour if Presenting >8 Hours after injury) if _LOC or amnesia_ AND
...
### Children (Under 16) - _Immediate_ CT (within 1 hour)
...
### Children (Under 16) - _Immediate_ CT (within 1 hour) if _more than 1_ of
...
- **Consider** CT even with _no other indications_ if on:
  - Vitamin K antagonists (e.g., warfarin).
  - DOACs (e.g., apixaban, rivaroxaban, dabigatran, edoxaban).
  - Heparin (LMWH or UFH).
  - Antiplatelets (excluding aspirin monotherapy).
- **Timing:**
  - Within 8 hours of injury _or_
  - Within 1 hour of presentation if presenting _more_ than 8 hours after the injury.
...
- Consider _after_ CT if neurological abnormality attributable to spinal cord injury.
...
- New, clinically important abnormality on imaging (but isolated, simple, linear, non-depressed skull fracture alone is _unlikely_ to be clinically important, unless on anticoagulants)
...
- **Discharge Advice:** Verbal _and_ written, to patient _and_ responsible adult. Include:
