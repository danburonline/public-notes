...
Double dipping frequently occurs in [fMRI](../01_techniques_in_neuroscience/fmri_image_quality.md) studies when researchers:
...
These practices inflate effect sizes and produce non-replicable findings (see [Neuroimaging analysis techniques](neuroimaging_analysis_techniques.md)).
...
See [Comparison of neuroimaging methods](../01_techniques_in_neuroscience/comparison_of_neuroimaging_methods.md) for methodological considerations across imaging modalities.
