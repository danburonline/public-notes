...
- **Understanding neural connectivity**: attractor dynamics explain how networks achieve synchronisation and maintain distinct states. In [physical reservoir computing](../../../001_private/social/twitter/physical_reservoir_computing.md), the echo state property — where dynamics asymptotically wash out initial conditions — is a direct instance of attractor-based computation.
...
- [Physical reservoir computing](../../../001_private/social/twitter/physical_reservoir_computing.md) — echo state property as attractor-based computation
