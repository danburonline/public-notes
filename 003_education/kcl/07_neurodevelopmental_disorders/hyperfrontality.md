...
![hyperfrontality](_attachments/hyperfrontality.png)
...
- The frontal lobes are critical for a variety of functions, including:
  - Problem-solving
  - [Memory](../02_psychological_foundations/working_memory_model.md)
  - Language
  - Judgment
  - Impulse control
...
- Disorders often linked with hyperfrontality include:
  ...
  - **[Bipolar](../03_mental_health_in_the_community/spectrum_of_bipolar_disorder.md) Disorder**: Involves episodes of mood swings ranging from depressive lows to manic highs.
