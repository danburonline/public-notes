...
Membrane channels are protein structures that allow ions to pass in and out of neurons, contributing to the [resting membrane potential](../kcl/01_techniques_in_neuroscience/resting_membrane_potential.md) and the generation of action potentials.

- **Resting K+ Channels**: These are selectively permeable to K+ ions and are always open, allowing K+ to move freely across the membrane, contributing to the [resting membrane potential](../kcl/01_techniques_in_neuroscience/resting_membrane_potential.md).
...
- **Resting Membrane [Potential](../kcl/01_techniques_in_neuroscience/resting_membrane_potential.md)**: Established by the differential distribution of ions across the neuronal membrane, particularly due to K+ and Na+ ions through their respective channels.
...
- **Synaptic Integration**: Occurs when a neuron processes all incoming synaptic inputs, facilitated by various types of [ion channels](../kcl/01_techniques_in_neuroscience/ion_channels.md) that determine the postsynaptic potential.
