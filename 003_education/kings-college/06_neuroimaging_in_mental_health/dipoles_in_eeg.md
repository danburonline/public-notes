...
![dipoles](_attachments/dipoles.png)
...
- **[Synchrony](../../../001_private/books/_general/interbrain_synchrony.md) of [Activity](../01_techniques_in_neuroscience/types_of_biological_electrical_activity.md)**: EEG is most sensitive to the synchronous activity of neurons with similar spatial orientation, creating a larger and more coherent electric field.

## Populations of Dipoles

- **Aggregate [Effect](../01_techniques_in_neuroscience/the_bold_effect.md)**: EEG does not measure the activity of individual neurons but rather the summation of synchronous activity of thousands or millions of dipoles. This is referred to as the "accumulated field."
- **[Pyramidal Neurons](pyramidal_neurons.md)**: The primary contributors to the EEG signal are the [pyramidal neurons](pyramidal_neurons.md) in the cerebral cortex due to their aligned perpendicular orientation to the cortical surface.
