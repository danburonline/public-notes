...
- EPSPs occur when a neurotransmitter binds to a receptor that stimulates the opening of [ion channels](ion_channels.md), allowing positive ions to flow into the neuron. This makes the neuron more positive, moving it closer to the threshold for firing an action potential.
...
## Inhibitory [Post-Synaptic](../04_biological_foundations_of_mental_health/pre-_and_post-synaptic.md) Potentials (IPSPs)

IPSPs are graded **potentials that decrease the likelihood of an action potential.**

- IPSPs occur when a neurotransmitter binds to a receptor that stimulates the opening of [ion channels](ion_channels.md), allowing negative ions to flow into the neuron or positive ions to flow out of the neuron. This makes the neuron more negative, moving it further from the threshold for firing an action potential.
