...
- **Low temporal resolution** — the HRF peaks ~6 s after neural activity, compared to millisecond precision in [EEG](../06_neuroimaging_in_mental_health/dipoles_in_eeg.md). See [Comparison of neuroimaging methods](comparison_of_neuroimaging_methods.md)
- **Susceptibility artefacts** — signal dropout near air-tissue interfaces (sinuses, ear canals) can obscure regions of interest. See [fMRI image quality](fmri_image_quality.md)
...
- **[Double-dipping](../06_neuroimaging_in_mental_health/double-dipping.md)** — statistical pitfalls arise when the same BOLD data are used for both selection and analysis

## Relation to Other Concepts

- [Neurovascular coupling](../06_neuroimaging_in_mental_health/neurovascular_coupling.md) — the mechanism that links neural activity to the blood flow changes BOLD detects
- [Cerebral blood flow](../06_neuroimaging_in_mental_health/cerebral_blood_flow.md) — what is being modulated in the BOLD response
- [Initial dip in BOLD signal](initial_dip_in_bold_signal.md) — the early transient before the main HRF peak
- [fMRI image quality](fmri_image_quality.md) — spatial resolution, SNR, and artefacts affecting BOLD measurement
- [Cognitive subtraction](cognitive_subtraction.md) — experimental design principle for isolating BOLD signal changes
- [Dipoles in EEG](../06_neuroimaging_in_mental_health/dipoles_in_eeg.md) — contrasting electrical vs haemodynamic measures of brain activity
