...
Even small head movements (< 1 mm) can introduce substantial errors, as the [BOLD signal](the_bold_effect.md) change is small. Mitigation strategies include:
...
- [The BOLD effect](the_bold_effect.md): The signal being measured
- [Initial dip in BOLD signal](initial_dip_in_bold_signal.md): Early transient affecting temporal dynamics
- [Cognitive subtraction](cognitive_subtraction.md): Experimental design to isolate signal of interest
- [Multi-modal imaging](multi-modal_imaging.md): Combining fMRI with other modalities to overcome limitations
- [Comparison of neuroimaging methods](comparison_of_neuroimaging_methods.md): How fMRI compares to alternative techniques
