...
- **[Population](../../../001_private/books/Essential%20Math%20for%20Data%20Science/Sample%20vs%20population.md) Mean:** The average value in the entire population from which the sample is drawn.
...
In a t-test, the t-value is used to calculate the [P-value](../../../001_private/books/Essential%20Math%20for%20Data%20Science/P-value.md), which then helps to determine whether to reject the null hypothesis. The steps include:
...
3. **Determine the [p-value](../../../001_private/books/Essential%20Math%20for%20Data%20Science/P-value.md)**, which indicates the probability of observing a t-value as extreme as, or more extreme than, the observed value if the null hypothesis is true.
...
> - Similar to the [p-value](../../../001_private/books/Essential%20Math%20for%20Data%20Science/P-value.md), the t-value’s significance can be influenced by the sample size.
