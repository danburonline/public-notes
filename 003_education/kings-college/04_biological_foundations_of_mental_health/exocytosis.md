...
![exocytosis](_attachments/exocytosis.png)
...
## The [Synapse](types_of_synapses.md)
...
## Steps in [Synaptic](pre-_and_post-synaptic.md) Exocytosis
...
3. **Vesicle [Priming](../../../001_private/books/short_introduction_to_memory/priming.md):** The vesicles are made ready for fusion. This involves the SNARE complex, which includes proteins like syntaxin and SNAP-25 on the plasma membrane, and synaptobrevin on the vesicle membrane.
4. **Action [Potential](graded_potential.md) Arrival:** The arrival of an action potential at the presynaptic terminal triggers the opening of voltage-gated calcium channels.
