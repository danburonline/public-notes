...
![histogenesis](../../../_inbox/attachments/histogenesis.jpg)
...
2. **Migration**: Cells move to their appropriate locations. See [Neuronal migration](neuronal_migration.md).
3. **Differentiation**: Cells take on specific characteristics and functions.
4. **Death** (also known as [apoptosis](../08_advances_in_neuroscience/apoptosis.md)): Some cells die to shape the final structure of the tissue or organ.
