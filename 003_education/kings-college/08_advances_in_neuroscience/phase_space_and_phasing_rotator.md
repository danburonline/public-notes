...
## Phase [Space](../../../001_private/videos/latent_space.md)

![phase-space](_attachments/phase-space.png)

- **Definition**: Represents all possible states of a system.
- **Applications**:
  - **Visualisation**: Helps visualise neural signal dynamics.
  - **State [Analysis](../06_neuroimaging_in_mental_health/spectral_analysis_in_eeg.md)**: Identifies patterns like stable points or chaotic behaviours in neural systems.

## Phasing Rotator

![reconstructed-space](_attachments/reconstructed-space.png)
