...
- [Point neuron](../../../002_profession/blue-brain-project/Point%20neuron.md): Abstract, represents firing rate without spatial extent

[NeuroML](../../../004_subsidiary/_%20general/NeuroML.md) provides a standardised XML format for exchanging neural models across simulation platforms.
...
| [Point neuron](../../../002_profession/blue-brain-project/Point%20neuron.md) | Low (firing rate) | Low | Large-scale models |

[NeuroML](../../../004_subsidiary/_%20general/NeuroML.md) enables interoperability between these approaches.
