...
> [!example] Emergence (quick intuition)
> - Weak emergence: a system has a property not present in its parts individually, yet in principle it can be derived from the micro-level rules (often only via simulation).
> - Strong emergence: a system has a property that cannot, even in principle, be fully accounted for by its parts and micro-level rules.