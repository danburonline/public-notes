...
A **philosophical zombie** (or p-zombie) is a thought experiment introduced by philosopher David Chalmers in 1996. It describes a hypothetical being that is physically and behaviourally identical to a human but entirely lacks conscious experience ([[Qualia|qualia]]).
...
- **Brain-Computer Interfaces:** Can we create artificial consciousness or detect it in others? This question is central to approaches like [[PSNST|Progressive Synthetic Neural Substrate Transfer]].
- **Ethical Implications:** If zombies are possible, should we treat them differently?
- **[[Naturalisation of phenomenology]]:** Bridging first-person phenomenological methods with third-person neuroscience may offer tools to distinguish genuine consciousness from zombie-like processing.
