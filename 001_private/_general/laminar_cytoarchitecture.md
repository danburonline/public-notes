...
- **Layer II (External Granular Layer)**: Contains small [pyramidal neurons](../../003_education/kings-college/06_neuroimaging_in_mental_health/pyramidal_neurons.md) and numerous stellate neurons, involved in local processing.
- **Layer III (External Pyramidal Layer)**: Composed of medium-sized [pyramidal neurons](../../003_education/kings-college/06_neuroimaging_in_mental_health/pyramidal_neurons.md) that project to other cortical areas.
...
- **Layer V (Internal Pyramidal Layer)**: Contains large [pyramidal neurons](../../003_education/kings-college/06_neuroimaging_in_mental_health/pyramidal_neurons.md) that project to subcortical structures, including the brainstem and spinal cord.
