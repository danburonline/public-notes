...
- **[Semantic](../../../003_education/kcl/02_psychological_foundations/long-term_memory.md#semantic-memory) priming:** Occurs when the prime and the target are semantically related, i.e., they have similar meanings (e.g., “doctor” priming for “nurse”).
- **[Perceptual](../../../003_education/kcl/02_psychological_foundations/long-term_memory.md#perceptual-memory) priming:** This relies on the form of the stimulus and is based on a sensory modality (e.g., a certain smell or sound may trigger a specific memory).
