...
![craniotomy](_attachments/craniotomy.jpg)
...
Craniotomy is the **enabling access procedure** for any physical intervention on neural substrate. Every step of [Progressive Synthetic Neural Substrate Transfer](../../_general/psnst.md)—from initial neural architecture mapping to sequential layering of synthetic tissue—requires controlled intracranial access that craniotomy provides.
...
- Could [perturbational complexity index](neural_correlate_of_consciousness.md) monitoring during awake craniotomy inform the consciousness verification protocol for PSNST?
