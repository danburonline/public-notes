...
5. **Unity of [Consciousness](../sizing_up_consciousness/levels_of_cognitive_complexity.md#consciousness)**: Explaining the emergence of a unified subjective experience.
...
- Relates to theories of consciousness (e.g., Global Workspace Theory, [Integrated Information Theory](../../videos/integrated_information_theory.md)).
...
4. **[Vector](../neural_networks_from_scratch/column_and_row_vectors.md) Symbolic Architectures (VSA)**:
...
1. **Temporal [Synchrony](../_general/interbrain_synchrony.md)**: Binding through synchronised neural firing.
