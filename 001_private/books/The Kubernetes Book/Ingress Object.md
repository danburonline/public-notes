...
Ingress in Kubernetes is a set of routing rules dictating how external users can access services within a [Kubernetes](Multi-container%20pod%20patterns.md) cluster.
