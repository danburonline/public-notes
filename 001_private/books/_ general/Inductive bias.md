...
- **Role in [Generalisation](../../../003_education/kings-college/02%20Psychological%20Foundations/Generalisation%20gradient.md)**: Allows algorithms to make inductive leaps from finite datasets to broader patterns; without it, learning would be impossible as infinite hypotheses could fit the data.
