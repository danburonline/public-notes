...
![binomial-distribution](_attachments/binomial-distribution.jpg)
...
4. **Constant [Probability](probability_approaches.md)**: Each trial’s probability of success (p) is the same.
