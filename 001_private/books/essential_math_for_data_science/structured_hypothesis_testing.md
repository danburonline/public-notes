...
3. **Collect [Data](../../../004_subsidiary/courses/datacamp_ml_scientist/types_of_data.md)**: Collect relevant data through experiments, surveys, or observational studies.
4. **Perform a [Statistical](common_statistical_issues.md) Test**: Conduct a statistical test to determine the [P-value](p-value.md), which is the probability of obtaining the observed data (or more extreme) if the null hypothesis is true.
