...
Ingress in Kubernetes is a set of routing rules dictating how external users can access services within a [Kubernetes](multi-container_pod_patterns.md) cluster.
