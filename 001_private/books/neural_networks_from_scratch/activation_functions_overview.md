...
![activation-functions](_attachments/activation-functions.png)
...
### ReLU (Rectified [Linear](../../../004_subsidiary/courses/datacamp_ml_scientist/regression.md#2-linear-regression) Unit)
...
- **Formula**: $f(x) = x$
- **Characteristics**: Output is the same as the input, used in [regression](../../../004_subsidiary/courses/datacamp_ml_scientist/regression.md) problems.
