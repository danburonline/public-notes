...
Occurrences, tokens, and tropes are three notions of particularity in metaphysics — events that happen, instances of types, and instances of properties.
...
- **Context**: Used in the philosophy of language and metaphysics to distinguish between abstract notions (types) and their concrete instances (tokens); the distinction underpins [multiple realisability](../how_to_build_a_brain/multiple_realisability.md) arguments.
...
- **Example**: The specific redness of an apple as a unique shade and instance of the colour.

See: [supervenience](supervenience.md)
