...
![stats-types](_attachments/stats-types.png)
...
2. **Inferential statistics** involves techniques used to make inferences or draw conclusions about a population based on a sample of data. It includes methods like hypothesis testing, confidence intervals, and [regression](regression.md) analysis. Inferential statistics help generalise findings from a sample to a larger population and assess the significance of relationships or differences observed in the data.
